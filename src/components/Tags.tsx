...
export const Tags = () => (
  <Box w="100%">
    <Box maxW="720px" mx="auto" px={12} pb={12}>
      ...
      <Text textStyle="tag">The open machine is a cryptographic gate against the tyranny of the present.</Text>
      <Text textStyle="tag">The open machine is a stochastic vehicle of emergence and fugitive time.</Text>
