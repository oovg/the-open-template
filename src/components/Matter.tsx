  ...
  <Box w="100%" p={12} id="matters">
    ...
    <Flex maxW="720px" mx="auto" border="1px solid" borderColor="primary" flexWrap="wrap">
        <Flex direction="column" w={['100%', null, '55%']} p={12}>
            ...
            <Flex gap={6} mt={12}>
              <Button as={Link} href="https://zora.co/collect/oeth:0x2d17e1c913a616e30ff267afda30a69d9ad25343" target="_blank" rel="noopener noreferrer">Read & Collect</Button>
              <Button as={Link} href="https://theopenmachine.myshopify.com/" target="_blank" rel="noopener noreferrer">Redeem</Button>
            </Flex>
        </Flex>
