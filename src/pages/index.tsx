    ...
    <Flex direction="column" alignItems="start" justifyContent="space-between" w="100vw">
      ...
      <main>
        ...
        <Flex id="what-we-do" direction="column" alignItems="start" justifyContent="space-between" maxW="600px" mx="auto" position="relative" p={10} display={['flex', null, 'none']}>
          ...
          <Text mt={5}>The Open Machine is premised on an alternative mode of social organization, a semi-formal set of values and operational principles we refer to as
            <Tooltip
          ...
          <Text mt={5}>In an age of ascendant
            ...
            , the emergent principles of the underground are in a position to scale to conspicuous dominance as cynical actors and obsolete formulas fall beneath the compounding increase in degrees of freedom the new forms provide. technologies, the emergent principles of the underground are in a position to scale to conspicuous dominance as cynical actors and obsolete formulas fall beneath the compounding increase in degrees of freedom the new forms provide.</Text>
          <Text mt={5}>The Open Machine is here to midwife that process. Our work is to discover alignment and build coalitions (and lineages) around key underground values. This also means recognizing the open, public and <Tooltip
